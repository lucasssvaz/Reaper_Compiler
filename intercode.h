...
typedef enum {  opADD, opSUB, opMULT, opDIV, opMOD, opSHL, opSHR, opLT, opLTE, opGT, opGTE, opAND, opOR, opASSIGN, opALLOC, opIMMED, opLOAD, opSTORE, opVEC, opGOTO, opIF, opRET, opFUN, opEND, opPARAM, opCALL, opARG, opLAB, opHLT} OpKind;
